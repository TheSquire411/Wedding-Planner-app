...
import { Heart, ArrowLeft, DollarSign, Plus, Edit3, TrendingUp, TrendingDown } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-sage-50">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-serif font-semibold text-gray-800">Budget Tracker</span>
            </div>
          </div>
        </div>
      </nav>
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-xl text-gray-600">Track your expenses and stay within budget</p>
        </div>
